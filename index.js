...
mongoose.connect('mongodb+srv://pri:prijey123@cluster0.rnvnxzn.mongodb.net/newDb?retryWrites=true&w=majority',{ //to connect the monngoose(const,mongoose connect,find command)
